...
const PageHeader = ({
    ...
    return (
        <div className={cn([
            ...
            <div className="container mx-auto flex flex-col items-center justify-center text-white z-20 space-y-3">-
                ...
                <Fade>
                <p className='max-w-lg text-center mx-auto'>{subtitle}</p>
                </Fade>
            </div>
        </div>
    )
