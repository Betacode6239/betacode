...
const ServiceSectionCard = ({
    ...
    return (
        <div className='rounded-xl bg-primary/10 p-5 space-y-3 flex flex-col items-center group hover:bg-primary hover:text-primary-foreground duration-200 transition-all  [&>*]:duration-200 [&>*]:transition-all'>
            ...
            <h3 className='text-slate-700 text-lg font-bold group-hover:text-primary-foreground'>{title}</h3>
            <p className='text-center group-hover:text-primary-foreground'>{desc}</p>
        </div>
    )
}
...
const ServicesSection = () => {
    ...
    return (
        <Section className='bg-left-top bg-no-repeat' style={{ backgroundImage: `url(${'/assets/images/shape-2.png'})` }}>
            <div ref={ref} className='container mx-auto grid-cols-1 md:grid-cols-2 grid gap-5 items-center'>
                ...
                <div className="grid  grid-cols-1 md:grid-cols-2 gap-5">

                    {
                        rightTrails.map((rt, index) => {
                            return <animated.div key={nanoid()} style={{...rt}} ><ServiceSectionCard key={nanoid()} {...contents[index]} /></animated.div>
                        })
                    }
                </div>
            </div>
